...
from transformers.models.opt.modeling_opt_pit_training import OPTForCausalLM
import copy
# from transformers.models.opt.modeling_opt_sparse import OPTModel
...
def main():
    ...
    if training_args.do_train:
        ...
        with open("results.txt", "a") as f:
            f.write(f"{model_args.model_name_or_path},PIT,{end - st},{memory}\n")
