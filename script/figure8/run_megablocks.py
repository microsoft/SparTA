...
from transformers.models.switch_transformers.modeling_switch_transformers_megablocks import SwitchTransformersSparseMLP, SwitchTransformersModel
import torch
import os
import joblib
import numpy as np
...
for k, v in model.named_modules():
    if isinstance(v, SwitchTransformersSparseMLP):
        v.fuse_expert(bsz, max_seq_length, args.use_fp16 == "True")
model.eval()
...
with open("results.txt", "a") as f:
    f.write(f"{args.use_fp16},{args.expert_number},{args.batch_size},MegaBlocks,{end - st},{memory}\n")
