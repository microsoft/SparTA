...
from transformers.models.switch_transformers.modeling_switch_transformers_pit import SwitchTransformersSparseMLP, SwitchTransformersModel
import torch
import os
import joblib
import numpy as np
...
with open("results.txt", "a") as f:
    f.write(f"{args.use_fp16},{args.expert_number},{args.batch_size},PIT,{end - st},{memory}\n")
