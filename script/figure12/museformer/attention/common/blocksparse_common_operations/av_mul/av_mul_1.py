...
def do_sample_av_mul_base(self, sample_attn_weights, sample_v, sample_layout, real_part, sample_idx, tgt_len):
    ...
    if dsd_matmul_key in self.instant_pocket:
        ...
        convert_overhead = dsd_matmul.convert_overhead
    ...
    return sample_out, convert_overhead
...
def do_av_mul_for_part(self, attn_weights_inc_part, v, attn_mask, real_part, tgt_len):
    ...
    for sample_idx in range(bsz):
        ...
        sample_out, c = do_sample_av_mul_base(self, sample_attn_weights, sample_v, sample_layout, real_part,
                                           sample_idx, tgt_len)
        convert_overhead += c
    ...
    return result, convert_overhead
