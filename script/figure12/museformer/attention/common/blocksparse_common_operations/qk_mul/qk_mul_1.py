...
def do_sample_qk_scores_base(
    ...
    if sdd_matmul_key in self.instant_pocket:
        ...
        convert_overhead = sdd_matmul.convert_overhead
    ...
    return sample_attn_scores, convert_overhead
...
def do_qk_scores_for_part(
    ...
    for idx in range(bsz):
        ...
        sample_attn_scores, c = do_sample_qk_scores_base(
            self,
    ...
    return attn_scores, convert_overhead
