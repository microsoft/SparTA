...
# @Last Modified time: 2023-07-22 08:48:47
...
# from transformers.models.bert.sparse_nn_pruning_modeling_bert import BertForSequenceClassification
from transformers.models.bert.modeling_bert import BertForSequenceClassification
from transformers.trainer_nn_pruning import Trainer
...
if __name__ == "__main__":
    parser = HfArgumentParser((PruningArguments, ModelArguments, TrainingArguments, DataTrainingArguments, SparseTrainingArguments))
    pruning_args, model_args, training_args, data_args, sparse_args = parser.parse_args_into_dataclasses()
    ...
    mpc = ModelPatchingCoordinator(
        ...
        model_name_or_path=sparse_args.distil_teacher_name_or_path,
    )
