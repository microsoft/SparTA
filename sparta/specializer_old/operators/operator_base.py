...
class OperatorBase(torch.nn.Module):
    ...
    def __init__(self, raw_module: torch.nn.Module):
        ...
        self._mask = None
        self.ready = False
        self._possible_implementations: Dict[str, kernels.KernelBase] = {}
    ...
    def tester(
        self, params: Dict, sample_inputs: List, weight_bk: float=0.0,
        ...
        '''
        self.build(params, sample_inputs, jit=True)
