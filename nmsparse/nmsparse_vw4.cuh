...
namespace nmsparse {
	...
	extern "C" __global__ void nmsparse_vw4_gemm_simt_fp32_fp32_fp32_32x128x64_8x4(float *g_vec, float *g_mat_data, int *g_mat_index, float *g_data, const int M, const int N, const int K, const float sparsity)
	{
