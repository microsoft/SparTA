...
int main(int argc, char*argv[]) {
    ...
    int m     = 32; // bigger sizes may require dynamic allocations
    int n     = 32; // bigger sizes may require dynamic allocations
    int k     = 32; // bigger sizes may require dynamic allocations
    m = atoi(argv[1]);
    k = atoi(argv[2]);
    n = atoi(argv[3]);
    ...
    int8_t *hA = (int8_t*)malloc(sizeof(int8_t)*m*k);
    int8_t *hB = (int8_t*)malloc(sizeof(int8_t)*k*n);
    int8_t *hC = (int8_t*)malloc(sizeof(int8_t)*m*n);
    for (int i = 0; i < m * k; i++)
